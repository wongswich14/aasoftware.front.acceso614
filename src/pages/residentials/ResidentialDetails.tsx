...
import ResidentialCreateVisit from "./ResidentialDetailsComponents/Visits/ResidentialCreateVisit.tsx";
...
const ResidentialDetails: React.FC = () => {
    ...
    return (
        <div className='w-full bg-white min-h-full rounded-md'>
            ...
            {openCreateModal && activeTab == "visitas" && <ResidentialCreateVisit toggleModal={toggleCreateModal} />}
